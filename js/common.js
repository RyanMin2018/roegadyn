...
function setLogonStatusSection(strid, strnm) {
	if (strid.length>0) {
		document.write("<span><a href='/account/Modify.php' title='Account Management'>"+ strnm.toUpperCase() +"</a></span>");
		document.write("<a href='/account/Logout.php' class='btn' title='logout'>LOGOUT</a>");
	} else {
		document.write("<a href='/account/Logon.php' class='btn' title='login'>LOGIN</a><a href='/account/Registration.php' class='btn logon' title='create account'>CREATE ACCOUNT</a>");
	}
};
